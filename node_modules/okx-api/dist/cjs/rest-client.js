...
class RestClient extends BaseRestClient_js_1.default {
    /**
     *
    ...
    setTradingConfig(params) {
        return this.postPrivate('/api/v5/account/set-trading-config', params);
    }
    precheckSetDeltaNeutral(params) {
        return this.getPrivate('/api/v5/account/precheck-set-delta-neutral', params);
    }
    /**
     *
    ...
    cancelRedeemETHStaking(params) {
        return this.postPrivate('/api/v5/finance/staking-defi/eth/cancel-redeem', params);
    }
