import { WS_API_TAG_OPERATIONS, } from '../types/websockets/ws-api.js';
 ...
 */
export function getDemoWsKey(wsKey) {
    switch (wsKey) {
...
export function getWsKeyForTopicChannel(market, channel, isPrivate) {
...
export function getWsKeyForMarket(market, isPrivate, isBusinessChannel) {
    switch (market) {
        ...
        default: {
            throw neverGuard(market, `getWsKeyForTopic(): Unhandled market "${market}"`);
        }
    }
}
export function requiresWSAPITag(operation, wsKey) {
    switch (wsKey) {
        case WS_KEY_MAP.prodPublic:
        case WS_KEY_MAP.prodDemoPublic:
        case WS_KEY_MAP.eeaLivePublic:
...
export function validateWSAPITag(request, wsKey) {
 ...
 */
export function getWsUrlForWsKey(wsKey, wsClientOptions, logger) {
...
export function getMaxTopicsPerSubscribeEventForMarket(market) {
    switch (market) {
        case 'prod':
        case 'EEA':
        case 'GLOBAL':
...
export function isWsPong(event) {
