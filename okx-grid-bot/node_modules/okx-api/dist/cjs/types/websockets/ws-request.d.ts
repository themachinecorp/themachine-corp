...
export interface WsPrivateChannelArgBalanceAndPosition extends WsBaseRequestArg {
...
export interface WsPublicChannelArgInstId extends WsBaseRequestArg {
    channel: 'tickers' | 'open-interest' | WsPublicKlineChannel | WsPublicMarkPriceKlineChannel | WsPublicIndexKlineChannel | 'trades' | 'mark-price' | 'price-limit' | WsPublicOrderBooksChannel | 'funding-rate' | 'index-tickers';
    instId: string;
}
